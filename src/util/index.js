 ...
 * @Autor: Espada
 * @Date: 2022-01-14 16:00:07
 * @LastEditors: Espada
 * @LastEditTime: 2022-01-19 17:35:25
 * @FilePath: \earth\src\util\index.js
 */
...
function cacheImages () {
  const images = ['dot-inverted.png', 'earth-glow.jpg',
    'map_inverted.png', 'map.png',
    'star.jpg', 'universe.jpg'
  ]

  return () => {
    const caches = images.map(v => {
...
function colorMix (p, c0, c1) {
  ...
  if (c0.length > 7) {
    ...
    const t = w((c1 || (p < 0 ? '#000000' : '#FFFFFF'))
      .slice(1), 16)
    var R1 = f >> 16
    var G1 = f >> 8 & 0x00FF
    var B1 = f & 0x0000FF
